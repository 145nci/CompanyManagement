...
use CompanyManagementBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CompanyManagementBundle\Form\DepartmentType', $department);
    ...
    {
        $deleteForm = $this->createDeleteForm($department);
        $editForm = $this->createForm('CompanyManagementBundle\Form\DepartmentType', $department);
